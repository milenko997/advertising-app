...
export default function Create({ categories }) {
    ...
    return (
        <AppLayout header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Post Advertisement</h2>}>
            <div className="py-8">
                    ...
                    <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
                        ...
                        <form onSubmit={submit} encType="multipart/form-data">
                            ...
                            <div className="mt-6 flex items-center gap-3">
                                ...
                                <a href="/my-advertisements" className="text-sm text-gray-500 hover:text-gray-700">Cancel</a>
                            </div>
                        </form>
                    </div>
                </div>
