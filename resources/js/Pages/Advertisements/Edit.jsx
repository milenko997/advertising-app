                        ...
                        <form onSubmit={submit} encType="multipart/form-data">
                            ...
                            <div className="mt-5">
                                ...
                                <input
                                    ...
                                    className="hidden"
                                />
                                {(ad.images?.length > 0 || newPreviews.length > 0) ? (
                                    <>
                                        <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-2 mb-2">
                                            ...
                                            {(ad.images?.length ?? 0) + newPreviews.length < MAX_IMAGES && (
                                                <button
                                                    type="button"
                                        ...
                                        <span className="text-xs text-gray-400 dark:text-neutral-500 tabular-nums">
                                            {(ad.images?.length ?? 0) + newPreviews.length}<span className="text-gray-300 dark:text-neutral-600">/10</span>
                                        </span>
                                    </>
                                ) : (
                                    <button
