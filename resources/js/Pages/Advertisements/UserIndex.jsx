            ...
            <div id="page-my-ads" className="py-8">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="flex items-center justify-between mb-6">
                        <div>
                            <h1 className="text-2xl font-bold text-gray-900 dark:text-neutral-100">Moji oglasi</h1>
                            <p className="text-sm text-gray-500 dark:text-neutral-400 mt-0.5">{initialAds.total} oglas{initialAds.total === 1 ? '' : initialAds.total >= 2 && initialAds.total <= 4 ? 'a' : 'a'}</p>
                        </div>
                        <Link
                            href="/postavi-oglas"
                    ...
                    {adList.length === 0 ? (
                        <div className="text-center py-20 bg-white dark:bg-neutral-800 rounded-xl border border-gray-200 dark:border-neutral-700">
                            ...
                            <p className="text-gray-500 dark:text-neutral-400 mb-4">Još nemate oglasa.</p>
                            <Link
                                href="/postavi-oglas"
                        ...
                        <>
                            <div id="section-my-ads-list" className="space-y-3">
                                {adList.map(ad => (
                                    <div key={ad.id} className="bg-white dark:bg-neutral-800 border border-gray-200 dark:border-neutral-700 rounded-xl p-4 hover:border-orange-200 dark:hover:border-orange-800 hover:shadow-sm transition-all">
                                        ...
                                        <div className="flex gap-3">
                                            {ad.image ? (
                                                ...
                                                <div className="w-20 h-16 sm:w-24 sm:h-20 bg-gray-50 dark:bg-neutral-700 border border-gray-100 dark:border-neutral-600 rounded-lg flex items-center justify-center shrink-0">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <Link
                                                    href={`/oglas/${ad.slug}`}
                                                    className="font-semibold text-gray-900 dark:text-neutral-100 hover:text-orange-600 transition-colors line-clamp-1 text-sm sm:text-base"
                                                >
                                                    {ad.title}
                                                </Link>
                                                ...
                                                <div className="flex flex-wrap items-center gap-1.5 mt-1.5">
                                                    ...
                                                    {ad.is_expired ? (
                                                        ...
                                                        <span className="text-xs text-gray-400 dark:text-neutral-500">Ističe {ad.expires_at}</span>
                                                    )}
                                                    <span className="inline-flex items-center gap-1 text-xs text-gray-400 dark:text-neutral-500">
                                                        <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <div className="flex items-center gap-2 mt-3 pt-3 border-t border-gray-100 dark:border-neutral-700">
                                            ...
                                            <Link
                                                ...
                                                className="px-3 py-1.5 border border-gray-300 dark:border-neutral-600 rounded-lg text-xs font-medium text-gray-700 dark:text-neutral-300 hover:bg-gray-50 dark:hover:bg-neutral-700 transition"
                                            >
                                                Izmeni
                                            </Link>
                                            <button
                                            ...
                                            <span className="ml-auto text-xs text-gray-400 dark:text-neutral-500">{ad.created_at}</span>
                                        </div>
                                    </div>
                                ))}
                            </div>
